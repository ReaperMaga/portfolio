    ...
    return (
        <div className="flex flex-col justify-center items-start space-y-10 w-full 2xl:w-11/12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 w-full px-2">
                <AboutMeProjectCard title="MyAnimeApp" imageUrl="projects/myanimeapp.jpeg" url="https://github.com/benediktkaiser/myanimeapp-frontend">
                ...
                <AboutMeProjectCard title="Frostbite" imageUrl="projects/frostbite.jpeg" url="https://youtu.be/FiOE4P8z-gc">
                    <div className="py-px px-2 text-gray-300 bg-sky-500 rounded-md text-md">Game</div>
                </AboutMeProjectCard>
