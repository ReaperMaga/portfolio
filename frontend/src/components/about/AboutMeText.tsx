        ...
        <div className="flex flex-col justify-center items-start space-y-10 w-full 2xl:w-1/2">
            ...
            <div className="flex relative w-full">
                ...
                <p className="pl-5 md:text-xl text-gray-400 text-md">
                    ...
                    I taught myself programming by developing projects that I could use myself.
                    I never intended to really make money with my programming skills, but considered it more of a hobby.
                    After some time, my skills developed and I started doing contract programming.
