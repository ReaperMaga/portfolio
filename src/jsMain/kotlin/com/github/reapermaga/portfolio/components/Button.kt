...
fun RenderContext.customButton(text: String, type : ButtonType = ButtonType.PRIMARY, onClick: (event: MouseEvent) -> Unit = {}, classes: String = "") {
    button(joinClasses(type.classes, "transition text-white py-2 px-4 pr-5 rounded", classes)) {
